...
public class Acitivity_Settings extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_acitivity_settings);
        ...
        View.OnClickListener oclBtnGotoMainAct3 = new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(Acitivity_Settings.this, MainActivity.class);
